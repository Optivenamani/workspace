        ...
        <section className="bg-gray-900 text-white h-screen">
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
            <div className="mx-auto max-w-lg text-center w-full">
              <h2 className="text-3xl font-extrabold sm:text-4xl uppercase my-4">
                Your Site Visit Info:
              </h2>
              <p>
                <strong>Site Name:</strong> {siteVisit.site_name}
              </p>
              <p>
                <strong>Driver Name:</strong> {siteVisit.driver_name}
              </p>
              <p>
                <strong>Driver Contact:</strong>{" "}
                {siteVisit.driver_contact === null
                  ? "Null"
                  : siteVisit.driver_contact}
              </p>
              <p>
                <strong>Vehicle Registration:</strong> {siteVisit.vehicle_name}
              </p>
              <p>
            ...
            <div className="mx-auto w-full">
              <h2 className="text-3xl font-extrabold sm:text-4xl text-center my-4">
                YOUR CLIENT(S) INFO:
              </h2>
            </div>
            <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {siteVisit.clients.map((client, index) => (
                <div
                  key={index}
                  className="text-center block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
                >
