...
const Health = () => {
  ...
  const [healthGender, setHealthGender] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        toast.error("Error adding Health Project ", {
          position: "top-center",
          closeOnClick: true,
          pauseOnHover: true,
          draggable: true,
      ...
      // Display success notification
        ...
        toast.success("Health Project added successfully!", {
          position: "top-center",
          closeOnClick: true,
          pauseOnHover: true,
          draggable: true,
                  ...
                  <div>
                    <form onSubmit={handleSubmit}>
                      <label className="label font-bold text-xs">
                        Add a Health Project
                      </label>
                      <label className="label font-bold text-xs">
                        Name of the one assisted by Health Project
                      </label>
                      <input
                      ...
                      />
                      <label className="label font-bold text-xs">
                        Health Complication of the assisted
                      </label>
                      <input
                        className="input input-bordered w-full"
                        name="healthComplication"
                        value={healthComplication}
                        onChange={(e) => setHealthComplication(e.target.value)}
                        spellCheck
                        required
                      />
