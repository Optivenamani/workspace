...
const MarketersFeedback = () => {
    ...
    const handleDownload = async () => {
        ...
        try {
            const response = await axios.get('https://workspace.optiven.co.ke/api/site-visit-requests/download-pdf/marketer-feedback', {
                headers: {
            ...
            link.href = fileURL;
            link.download = 'marketer_feedback.pdf';
            link.click();
