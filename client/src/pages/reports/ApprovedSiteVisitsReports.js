...
const ApprovedSiteVisitsReports = () => {
    ...
    const handleDownload = async () => {
        ...
        try {
            const response = await axios.get('https://workspace.optiven.co.ke/api/site-visit-requests/download-pdf/approved-site-visits', {
                headers: {
            ...
            toast.error('An error occurred while downloading the PDF. Please try again later.', {
                position: "top-center",
                closeOnClick: true,
                pauseOnHover: true,
                draggable: true,
...
export default ApprovedSiteVisitsReports;
