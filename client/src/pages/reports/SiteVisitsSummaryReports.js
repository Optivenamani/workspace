...
const SiteVisitsSummary = () => {
    ...
    const handleDownload = async () => {
        ...
        try {
            const response = await axios.get('https://workspace.optiven.co.ke/api/site-visit-requests/download-pdf/site-visit-summary', {
                headers: {
            ...
            link.href = fileURL;
            link.download = 'site_visit_summary.pdf';
            link.click();
