...
const AssignedBookings = () => {
    ...
    const fetchTrips = async () => {
      try {
        const response = await fetch(
          "https://209.38.246.14:8080/api/drivers/assigned-site-visits",
          {
            headers: {
  ...
  const startTrip = async (id) => {
    try {
      const response = await fetch(
        `https://209.38.246.14:8080/api/site-visits/start-trip/${id}`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const endTrip = async (id) => {
    try {
      const response = await fetch(
        `https://209.38.246.14:8080/api/site-visits/end-trip/${id}`,
        {
          method: "PATCH",
          headers: {
            Authorization: `Bearer ${token}`,
