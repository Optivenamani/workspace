...
const VehicleRequestDetails = () => {
    ...
    const fetchDrivers = async () => {
      try {
        const response = await fetch(
          "https://209.38.246.14:8080/api/drivers/all-drivers",
          {
            headers: {
  ...
  useEffect(() => {
    const fetchVehicleRequest = async (id) => {
      try {
        const response = await fetch(
          `https://209.38.246.14:8080/api/vehicle-requests/pending-vehicle-requests/${id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  useEffect(() => {
    const fetchVehicles = async () => {
      try {
        const response = await fetch(
          "https://209.38.246.14:8080/api/vehicles/available",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const rejectVehicleRequest = async () => {
    try {
      ...
      const response = await fetch(
        `https://209.38.246.14:8080/api/vehicle-requests/reject-vehicle-request/${id}`,
        {
          method: "PATCH",
          headers: {
